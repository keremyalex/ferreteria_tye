                    ...
                    <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div class="p-6">
                            <div v-if="purchasesBySupplier.length > 0" class="space-y-4">
                                <div v-for="(supplier, index) in purchasesBySupplier" :key="index" class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700">
                                    <div class="flex items-center">
                                        <div class="flex items-center justify-center w-8 h-8 mr-3 text-sm font-medium text-purple-600 bg-purple-100 rounded-full dark:bg-purple-900 dark:text-purple-400">
                                            {{ index + 1 }}
                                        </div>
                                        <div>
                    ...
                    <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div class="p-6 overflow-y-auto max-h-96">
                            <div v-if="topPurchasedProducts.length > 0" class="space-y-3">
                                <div v-for="(product, index) in topPurchasedProducts.slice(0, 10)" :key="product.id" class="flex items-center justify-between p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20">
                                    <div class="flex items-center">
                                        <div class="flex items-center justify-center w-6 h-6 mr-3 text-xs font-bold text-blue-600 bg-blue-100 rounded-full dark:bg-blue-800 dark:text-blue-300">
                                            {{ index + 1 }}
                                        </div>
                                        <div>
                                            <div class="text-sm font-medium text-gray-900 dark:text-white">
